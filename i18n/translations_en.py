...
DICT = {
    ...
    "模型档位：": "Model tier:",
    "选择字幕语言。中文/英语/日语使用 PP-OCRv6 模型，其他语言自动回落 PP-OCRv5 多语言模型。":
        "Subtitle language. Chinese/English/Japanese use PP-OCRv6 models; other languages automatically fall back to the multilingual PP-OCRv5 models.",
